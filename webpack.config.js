...
Encore
    // directory where compiled assets will be stored (lieu ou tout est compilé par webpack)
    .setOutputPath('public/build/')
    // public path used by the web server to access the output path (chemin public ou tout est compilé par webpack, puisque "public" est l'index de l'App)
    .setPublicPath('/build')
    // only needed for CDN's or sub-directory deploy
    //.setManifestKeyPrefix('build/')

    /*
     * ENTRY CONFIG (chemin des fichier que l'on veut faire compiler à webpack)
     *
